...
class EnemyAI {
    constructor(options = {}) {
        ...
        // --- Movement tuning ---
        this.baseSpeed = options.baseSpeed ?? 220;        // units/sec (dt-based)
    ...
    update(enemy, playerPos, dt) {
        ...
        const speedMul = enemy.speed ?? 1.0;
        ...
        const desiredAlt = playerPos.y + 30;
    ...
    _chase(mesh, playerPos, dt) {
        ...
        this._lookMatrix.lookAt(mesh.position, playerPos, mesh.up);
